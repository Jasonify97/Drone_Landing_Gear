...
slop = patch([-22.25,22.25,22.25,-22.25], ...      %30도 각도 평면 만들기
             [-25,-25,25,25], ...
             [-29.9,-4,-4,-29.9],'g');         
alpha(slop,0.5)                                    %경사면 투명도 조정
...
set(box_L1,'ZData',[50-i 50-i]);                    %시작위치는 밑변:50,윗면:58 이며, 1씩 감소(50번 반복)
set(box_L2,'ZData',[50-i 50-i]);
set(box_L3,'ZData',[50-i 50-i]);
set(box_L4,'ZData',[50-i 50-i]);
set(box_L5,'ZData',[50-i 58-i]);
set(box_L6,'ZData',[50-i 58-i]);
set(box_L7,'ZData',[50-i 58-i]);
set(box_L8,'ZData',[50-i 58-i]);
set(box_L9,'ZData',[58-i 58-i]);
set(box_L10,'ZData',[58-i 58-i]);
set(box_L11,'ZData',[58-i 58-i]);
set(box_L12,'ZData',[58-i 58-i]);
set(Leg_L1,'ZData',[50-i L_z1_east-i]);
set(Leg_L2,'ZData',[L_z1_east-i L_z2_east-i]);
set(Leg_L3,'ZData',[50-i L_z1_west-i]);
set(Leg_L4,'ZData',[L_z1_west-i L_z2_west-i]);
set(Leg_L5,'ZData',[50-i L_z1_north-i]);
set(Leg_L6,'ZData',[L_z1_north-i L_z2_north-i]);
set(Leg_L7,'ZData',[50-i L_z1_south-i]);
set(Leg_L8,'ZData',[L_z1_south-i L_z2_south-i]);
pause(0.08);                                        %0.08초딜레이
end
...
for i_ptu = 1:length(Legu_theta1_west)                                       %애니매이션 실행 1부터theta_west크기까지 반복
    ...
    pause(0.02);                                               %0.초 딜레이 0에가까울수록 빠름(drawnow함수 이용시 제일 빠름)
end
...
a=linspace(1,1,50);                                 %1값을 50개 만들기
for i = 1:length(a)                                 %50번반복
set(box_T1,'ZData',[i i]);                          %시작위치는 밑변:50,윗면:58 이며, 1씩 감소(50번 반복)
set(box_T2,'ZData',[i i]);
set(box_T3,'ZData',[i i]);
set(box_T4,'ZData',[i i]);
set(box_T5,'ZData',[i 8+i]);
set(box_T6,'ZData',[i 8+i]);
set(box_T7,'ZData',[i 8+i]);
set(box_T8,'ZData',[i 8+i]);
set(box_T9,'ZData',[8+i 8+i]);
set(box_T10,'ZData',[8+i 8+i]);
set(box_T11,'ZData',[8+i 8+i]);
set(box_T12,'ZData',[8+i 8+i]);
set(Leg_T1,'ZData',[i T_z1_east+i]);
set(Leg_T2,'ZData',[T_z1_east+i T_z2_east+i]);
set(Leg_T3,'ZData',[i T_z1_west+i]);
set(Leg_T4,'ZData',[T_z1_west+i T_z2_west+i]);
set(Leg_T5,'ZData',[i T_z1_north+i]);
set(Leg_T6,'ZData',[T_z1_north+i T_z2_north+i]);
set(Leg_T7,'ZData',[i T_z1_south+i]);
set(Leg_T8,'ZData',[T_z1_south+i T_z2_south+i]);
pause(0.08);                                         %0.08초딜레이
end
