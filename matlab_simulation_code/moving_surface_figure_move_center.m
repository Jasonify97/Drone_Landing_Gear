...
move_surface_up2 = linspace(-22,-7.5,300);
move_surface_down2 = linspace(6,-7.5,length(move_surface_up2));

g_z2_east =linspace(-3,-7.5,length(move_surface_up2));
...
g_lex2 = 13.75:-0.1:7.94;
g_lez2 =linspace(7.5,7.5,length(g_lex2));

g_lcosth2 = (g_lex2.^2 + g_lez2.^2 -(cg_L1^2+cg_L2^2))/(2*cg_L1*cg_L2);
g_lsinth2 = sqrt(1-abs(g_lcosth2).^2);
g_lth2 = atan2d(g_lsinth2,g_lcosth2);
g_lth1 = atan2d(g_lez2,g_lex2) - atan2d(cg_L1+cg_L2*cosd(g_lth2),cg_L2*sind(g_lth2));

g_lex1 = cg_L1*sind(-g_lth1);
g_lez1 = cg_L1*cosd(-g_lth1);


%----------------------------------------------------------------------
g_rex2 =-2.13:-0.1:-7.94;                                                                                                                                                              
g_rez2 = linspace(7.5,7.5,length(g_rex2));

g_costh2 = (g_rex2.^2 + g_rez2.^2 -(cg_L1^2+cg_L2^2))/(2*cg_L1*cg_L2);
g_sinth2 = sqrt(1-abs(g_costh2).^2);
g_rth2 = atan2d(g_sinth2,g_costh2);
g_rth1 = atan2d(g_rez2,g_rex2) + atan2d(cg_L1+cg_L2*cosd(g_rth2),cg_L2*sind(g_rth2));

g_rex1 = cg_L1*sind(g_rth1);
g_rez1 = -cg_L1*cosd(g_rth1);


hpl3 = plot(ha,[-25 g_lex1(1)-25],[-7.5 g_lez1(1)-7.5],'b','Linewidth',3);            %L1이동하는 선생성(왼쪽다리)
hpl4 = plot(ha,[g_lex1(1)-25 g_lex2(1)-25],[g_lez1(1)-7.5 g_lez2(1)-7.5],'r','Linewidth',3);
hpr3 = plot(ha,[13.38 g_rex1(1)+13.38],[-7.5 g_rez1(1)-7.5],'b','Linewidth',3);             %L1이동하는 선생성(왼쪽다리)
hpr4 = plot(ha,[g_rex1(1)+13.38 g_rex2(1)+13.38],[g_rez1(1)-7.5 g_rez2(1)-7.5],'r','Linewidth',3); 

f2_hpl3 = plot(ha2,[-25 g_lex1(1)-25],[-7.5 g_lez1(1)-7.5],'b','Linewidth',3);            %L1이동하는 선생성(왼쪽다리)
f2_hpl4 = plot(ha2,[g_lex1(1)-25 g_lex2(1)-25],[g_lez1(1)-7.5 g_lez2(1)-7.5],'r','Linewidth',3);
f2_hpr3 = plot(ha2,[13.38 g_rex1(1)+13.38],[-7.5 g_rez1(1)-7.5],'b','Linewidth',3);             %L1이동하는 선생성(왼쪽다리)
f2_hpr4 = plot(ha2,[g_rex1(1)+13.38 g_rex2(1)+13.38],[g_rez1(1)-7.5 g_rez2(1)-7.5],'r','Linewidth',3); 
...
box_L10 = plot3(ha,[0 11.25],[-11.25 0],[78 78],'k','Linewidth',1.5);                        %부품넣을공간 생성(윗면)-착륙
box_L11 = plot3(ha,[11.25 0],[0 11.25],[78 78],'k','Linewidth',1.5);                         %부품넣을공간 생성(윗면)-착륙
box_L12 = plot3(ha,[0 -11.25],[11.25 0],[78 78],'k','Linewidth',1.5);      


for i_pt2 = 1:length(g_rex2)

set(box_L1,'XData',[-11.25-i_pt2 0],'YData',[-i_pt2 -11.25]);                    %시작위치는 밑변:70,윗면:78 이며, 1씩 감소(70번 반복)

set(box_L2,'ZData',[70-i_pt2 70-i_pt2]);
set(box_L3,'ZData',[70-i_pt2 70-i_pt2]);
set(box_L4,'ZData',[70-i_pt2 70-i_pt2]);
set(box_L5,'ZData',[70-i_pt2 78-i_pt2]);
set(box_L6,'ZData',[70-i_pt2 78-i_pt2]);
set(box_L7,'ZData',[70-i_pt2 78-i_pt2]);
set(box_L8,'ZData',[70-i_pt2 78-i_pt2]);
set(box_L9,'ZData',[78-i_pt2 78-i_pt2]);
set(box_L10,'ZData',[78-i_pt2 78-i_pt2]);
set(box_L11,'ZData',[78-i_pt2 78-i_pt2]);
set(box_L12,'ZData',[78-i_pt2 78-i_pt2]);

set(ha2_box_L1,'ZData',[70-i_pt2 70-i_pt2]);                    %시작위치는 밑변:70,윗면:78 이며, 1씩 감소(70번 반복)
set(ha2_box_L2,'ZData',[70-i_pt2 70-i_pt2]);
set(ha2_box_L3,'ZData',[70-i_pt2 70-i_pt2]);
set(ha2_box_L4,'ZData',[70-i_pt2 70-i_pt2]);
set(ha2_box_L5,'ZData',[70-i_pt2 78-i_pt2]);
set(ha2_box_L6,'ZData',[70-i_pt2 78-i_pt2]);
set(ha2_box_L7,'ZData',[70-i_pt2 78-i_pt2]);
set(ha2_box_L8,'ZData',[70-i_pt2 78-i_pt2]);
set(ha2_box_L9,'ZData',[78-i_pt2 78-i_pt2]);
set(ha2_box_L10,'ZData',[78-i_pt2 78-i_pt2]);
set(ha2_box_L11,'ZData',[78-i_pt2 78-i_pt2]);
set(ha2_box_L12,'ZData',[78-i_pt2 78-i_pt2]);

set(hpl3,'XData',[-25 g_lex1(i_pt2)-25],'ZData',[-7.5 g_lez1(i_pt2)-7.5]);
set(hpl4,'XData',[g_lex1(i_pt2)-25 g_lex2(i_pt2)-25],'ZData',[g_lez1(i_pt2)-7.5 g_lez2(i_pt2)-7.5]);
set(hpr3,'XData',[13.38 g_rex1(i_pt2)+13.38],'ZData',[-7.5 g_rez1(i_pt2)-7.5]);
set(hpr4,'XData',[g_rex1(i_pt2)+13.38 g_rex2(i_pt2)+13.38],'ZData',[g_rez1(i_pt2)-7.5 g_rez2(i_pt2)-7.5]);

set(f2_hpl3,'XData',[-25 g_lex1(i_pt2)-25],'ZData',[-7.5 g_lez1(i_pt2)-7.5]);
set(f2_hpl4,'XData',[g_lex1(i_pt2)-25 g_lex2(i_pt2)-25],'ZData',[g_lez1(i_pt2)-7.5 g_lez2(i_pt2)-7.5]);
set(f2_hpr3,'XData',[13.38 g_rex1(i_pt2)+13.38],'ZData',[-7.5 g_rez1(i_pt2)-7.5]);
set(f2_hpr4,'XData',[g_rex1(i_pt2)+13.38 g_rex2(i_pt2)+13.38],'ZData',[g_rez1(i_pt2)-7.5 g_rez2(i_pt2)-7.5]);
